<template>
  <div>
    <nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center container-p-x bg-navbar-theme" id="layout-navbar">
          ...
          <a href="index.html" class="navbar-brand app-brand d-lg-none py-0 mr-4">
            ...
            <span class="app-brand-text font-weight-normal ml-2">JOVASOFT</span>
          </a>
          ...
          <div class="navbar-collapse collapse" id="layout-navbar-collapse">
            ...
            <div class="navbar-nav align-items-lg-center ml-auto">
              <div class="navbar-notifications nav-item dropdown mr-lg-3">
              ...
              <div class="navbar-messages nav-item dropdown mr-lg-3">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <div class="list-group list-group-flush">
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src="/products/appwork/v122/assets_/img/avatars/6-small.png" class="d-block ui-w-40 rounded-circle" alt="">
              ...
              <div class="navbar-user nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                  <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                    <img src="/products/appwork/v122/assets_/img/avatars/1.png" alt="" class="d-block ui-w-30 rounded-circle">
